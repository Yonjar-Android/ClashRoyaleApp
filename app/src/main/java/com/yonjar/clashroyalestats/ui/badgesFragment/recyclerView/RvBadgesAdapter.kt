...
class RvBadgesAdapter(private val context: Context, private var badgesList: List<Badges>):RecyclerView.Adapter<BadgesViewHolder>() {
    ...
    fun updateList(newList:List<Badges>){
